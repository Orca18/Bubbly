...
public class Kim_JoinedCom_Response {
    ...
    public Kim_JoinedCom_Response(String community_id, String community_owner_id, String community_name, String community_desc, String profile_file_name) {
