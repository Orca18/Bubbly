...
public class Posts_Item {
    ...
    public Posts_Item(String imageUrl, String userName, String userId, String postContent, String postMedia, int postLikeCount, int postReplyCount, int postRebuCount, String postURL, String postTime) {
